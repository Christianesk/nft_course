...
contract ERC1155 {
    ...
    //Get the balance of an accounts tokens
    ...
    //Get the balance of multiple accounts tokens
        ...
        returns (uint256[] memory)
    {
        require(
            ...
            "Accounts and ids are not same length"
        );
    ...
    // Enables or disablesan operator to manage all of msg.sender assets
    ...
    function safeBatchTransferFrom(
        ...
        require(
            ...
            "Ids and amount are not the same"
        );
